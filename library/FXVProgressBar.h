/**
 * @file FXVProgressBar.h
 * @author Riccardo Iacob
 * @brief FXVProgressBar Widget Class
 * @version 0.1
 * @date 2023-07-12
 *
 ...
 *
 */
#ifndef FXVPROGRESSBAR_H
#define FXVPROGRESSBAR_H

#include <Arduino.h>
#include "FXWidget.h"

class FXVProgressBar : public FXWidget
{
private:
protected:
...
public:
    FXVProgressBar(FXWindow *parent) : FXWidget(parent)
    {
    }
    /**
    ...
    void draw()
    {
        ...
        if (inverted)
        {
            ...
            widget->fillRoundRect(0, 0, widgetsizex, widgetsizey * multiplier, cornerradius, bgcolor);
        }
        else
        {
            widget->fillRoundRect(0, 0, widgetsizex, widgetsizey, cornerradius, bgcolor);
            widget->fillRoundRect(0, 0, widgetsizex, widgetsizey * multiplier, cornerradius, barcolor);
        }
        // Draw border
